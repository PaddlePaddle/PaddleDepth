...
def main_extract_subimages(args):
    ...
    It is used for 01/02/03... dataset.
    ...
    # LR images
    opt['input_folder'] = osp.join(args.data_root, 'x')
    opt['save_folder'] = osp.join(args.data_root, 'x_sub')
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Prepare Document Images dataset',
