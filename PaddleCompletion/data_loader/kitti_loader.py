...
def get_paths_and_transform(split, args):
    ...
    paths = {"rgb": paths_rgb, "d": paths_d, "gt_depth": paths_gt}
    # print(len(paths["rgb"]))
...
class KittiDepth(paddle.io.Dataset):
    ...
    def __getraw__(self, index):
        ...
        target = depth_read(self.paths['gt_depth'][index]) if \
            self.paths['gt_depth'][index] is not None else None
