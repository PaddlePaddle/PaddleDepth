...
class ENet(nn.Layer):
    def __init__(self, args):
        ...
        self.geoplanes = 3
        if self.args.model["convolutional_layer_encoding"] == "xyz":
            self.geofeature = GeometryFeature()
        elif self.args.model["convolutional_layer_encoding"] == "std":
            self.geoplanes = 0
        elif self.args.model["convolutional_layer_encoding"] == "uv":
            self.geoplanes = 2
        elif self.args.model["convolutional_layer_encoding"] == "z":
            self.geoplanes = 1
    ...
    def forward(self, input):
        ...
        if self.args.model["convolutional_layer_encoding"] == "xyz":
            geo_s1 = self.geofeature(
                d, vnorm, unorm, 352, 1216, c352, c1216, f352, f1216
            )
            geo_s2 = self.geofeature(
                d_s2, vnorm_s2, unorm_s2, 352 / 2, 1216 / 2, c352, c1216, f352, f1216
            )
            geo_s3 = self.geofeature(
                d_s3, vnorm_s3, unorm_s3, 352 / 4, 1216 / 4, c352, c1216, f352, f1216
            )
            geo_s4 = self.geofeature(
                d_s4, vnorm_s4, unorm_s4, 352 / 8, 1216 / 8, c352, c1216, f352, f1216
            )
            geo_s5 = self.geofeature(
                d_s5, vnorm_s5, unorm_s5, 352 / 16, 1216 / 16, c352, c1216, f352, f1216
            )
            geo_s6 = self.geofeature(
        ...
        rgb_feature2 = self.rgb_encoder_layer2(
            rgb_feature1, geo_s2, geo_s2
        )  # b 32 176 608
        rgb_feature3 = self.rgb_encoder_layer3(
            rgb_feature2, geo_s2, geo_s3
        )  # b 64 88 304
        rgb_feature4 = self.rgb_encoder_layer4(
            rgb_feature3, geo_s3, geo_s3
        )  # b 64 88 304
        rgb_feature5 = self.rgb_encoder_layer5(
            rgb_feature4, geo_s3, geo_s4
        )  # b 128 44 152
        rgb_feature6 = self.rgb_encoder_layer6(
            rgb_feature5, geo_s4, geo_s4
        )  # b 128 44 152
        rgb_feature7 = self.rgb_encoder_layer7(
            rgb_feature6, geo_s4, geo_s5
        )  # b 256 22 76
        rgb_feature8 = self.rgb_encoder_layer8(
            rgb_feature7, geo_s5, geo_s5
        )  # b 256 22 76
        rgb_feature9 = self.rgb_encoder_layer9(
            rgb_feature8, geo_s5, geo_s6
        )  # b 512 11 38
        rgb_feature10 = self.rgb_encoder_layer10(
            rgb_feature9, geo_s6, geo_s6
        )  # b 512 11 38
        ...
        sparsed_feature2 = self.depth_layer2(
        ...
        sparsed_feature4 = self.depth_layer4(
        ...
        sparsed_feature6 = self.depth_layer6(
        ...
        sparsed_feature8 = self.depth_layer8(
        ...
        sparsed_feature10 = self.depth_layer10(
            sparsed_feature9, geo_s6, geo_s6
        )  # b 512 11 38
...
class PENet_C1(nn.Layer):
    def __init__(self, args):
        ...
        index = [
            [j for j in range(ks * ks - 1, -1, -1)],
            [j for j in range(ks * ks)],
            [val for val in kernel_range_list for j in range(ks)],
            ls,
        ]
        encoder3[index] = 1
...
class PENet_C2(nn.Layer):
    ...
    def forward(self, input):
        ...
        depth_s2 = (
            kernel_conf3_s2 * depth3
            + kernel_conf5_s2 * depth5
            + kernel_conf7_s2 * depth7
        )
...
class PENet_C2_train(nn.Layer):
    ...
    def forward(self, input):
        ...
        depth_s2_00 = (
            kernel_conf3_s2 * depth3_s2_00
            + kernel_conf5_s2 * depth5_s2_00
            + kernel_conf7_s2 * depth7_s2_00
        )
        depth_s2_01 = (
            kernel_conf3_s2 * depth3_s2_01
            + kernel_conf5_s2 * depth5_s2_01
            + kernel_conf7_s2 * depth7_s2_01
        )
        depth_s2_10 = (
            kernel_conf3_s2 * depth3_s2_10
            + kernel_conf5_s2 * depth5_s2_10
            + kernel_conf7_s2 * depth7_s2_10
        )
        depth_s2_11 = (
            kernel_conf3_s2 * depth3_s2_11
            + kernel_conf5_s2 * depth5_s2_11
            + kernel_conf7_s2 * depth7_s2_11
        )
        ...
        refined_depth_s2 = (
            depth * att_map_12[:, 0:1, :, :] + depth_s2 * att_map_12[:, 1:2, :, :]
        )
